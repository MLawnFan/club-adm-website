 ...
 * Texte défilant en boucle (marquee) alternant entre les promos et événements
...
const PROMO_ITEMS = [
  {
    text: "ON RSTART LA MACHINE — PROGRAMME DE TRANSFORMATION",
    emoji: "\uD83D\uDCAA",
    href: "/consultation-gratuite",
    cta: "En savoir plus →",
  },
  {
    text: "ÉVÉNEMENT COURSE — 19 SEPTEMBRE · CHAMBLY",
    emoji: "\uD83C\uDFC3",
          ...
          <div className="relative flex items-center justify-center h-10">
            ...
            <div className="absolute inset-0 flex items-center overflow-hidden">
              <div className="marquee-track flex whitespace-nowrap">
                {/* Alternate between promo items for seamless loop */}
                {Array.from({ length: 8 }).map((_, i) => {
                  const item = PROMO_ITEMS[i % PROMO_ITEMS.length];
                  return (
                    <Link
                      key={i}
                      href={item.href}
